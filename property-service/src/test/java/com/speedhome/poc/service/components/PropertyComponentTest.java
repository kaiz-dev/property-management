package com.property.poc.service.components;

import com.property.poc.client.api.PropertiesApi;
import com.property.poc.client.handler.ApiClient;
import com.property.poc.client.model.Property;
import com.property.poc.client.model.PropertyApproveReq;
import com.property.poc.client.model.PropertyReq;
...
public class PropertyComponentTest {
    ...
    private static final String BASE_PATH = "/property/backend/v1";
